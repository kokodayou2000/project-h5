...
<template>
  <div class="home-top">
    <div class="top">
      <img class="location-icon" src="@/assets/imgs/index_page/local.png" />
      <div class="location">镜湖广场</div>
...
.home-top {
  background: linear-gradient(to right, rgb(53, 200, 2500), rgb(31, 175, 243));
  color: white;
